...
from langchain_community.document_loaders import PyPDFLoader, TextLoader, Docx2txtLoader, CSVLoader, JSONLoader
from langchain_community.document_loaders.excel import UnstructuredExcelLoader

def load_all_documents(data_dir: str) -> List[Any]:
    '''
    Load all supported files from the data directory and convert to Langchain document structure
    Supported: PODF, TXT, CSV, Excel, Word, JSON
    '''
    ...
    for pdf in pdf_files:
        print(f'[DEBUG] Loading PDF: {pdf_files}')
        try:
            ...
            print(f'[ERROR] Failed to load PDF {pdf}: {e}')
